...
class RDSProvisioner {
    ...
    async provision(spec) {
        const instanceId = `cygni-${spec.projectId}-${spec.environment}-${(0, nanoid_1.nanoid)(6)}`;
        ...
        const command = new client_rds_1.CreateDBInstanceCommand({
    ...
    async provisionLogicalDatabase(spec) {
...
exports.RDSProvisioner = RDSProvisioner;
//# sourceMappingURL=provision-rds.js.map