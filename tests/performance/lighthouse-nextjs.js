...
async function runLighthouseAudit() {
  console.log('🚀 Starting Real Lighthouse Performance Audit on Next.js Server\n');
  ...
  try {
    ...
    // Run audit against the actual Next.js server
    ...
    const reportPath = path.join(__dirname, 'lighthouse-nextjs-report.json');
