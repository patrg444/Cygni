...
export function createServer() {
  ...
  // Budget endpoint
  app.get('/api/projects/:projectId/budget', jwtMiddleware(jwtService), async (req, res) => {
    try {
  ...
  // Stripe webhook
  app.post('/api/webhooks/stripe', express.raw({ type: 'application/json' }), async (_req, res) => {
