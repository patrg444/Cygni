...
function DeploymentMonitor({ deploymentId }: { deploymentId: string }) {
      ...
      {deployment.services && (
        <div className="space-y-2">
          ...
          {deployment.services.map((service) => (
            <div key={service.name} className="ml-4 text-sm">
...
export default function BuildsPage() {
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      {activeDeploymentId && (
        <DeploymentMonitor deploymentId={activeDeploymentId} />
      )}
                  ...
                  <tr key={deployment.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      ...
                      deployment.status === "in_progress" ? (
                        <button
                          onClick={() => setActiveDeploymentId(deployment.id || null)}
