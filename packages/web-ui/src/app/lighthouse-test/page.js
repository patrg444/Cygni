...
exports.default = LighthouseTestPage;
const react_1 = require("react");
function LighthouseTestPage() {
    const [posts] = (0, react_1.useState)([
    ...
    return (<div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {posts.map((post) => (<article key={post.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow p-6">
