...
const CategoriesForm_1 = require("../../components/categories/CategoriesForm");
const sdk_1 = require("@cygni/sdk");
function CategoriesPage() {
    const [showForm, setShowForm] = (0, react_1.useState)(false);
    const [editingId, setEditingId] = (0, react_1.useState)(null);
    const { data, isLoading, error, refetch } = (0, sdk_1.useCategoriesList)();
    const deleteMutation = (0, sdk_1.useDeleteCategory)();
    const handleEdit = (id) => {
        setEditingId(id);
        setShowForm(true);
    };
    ...
    return (<div className="container mx-auto py-8 px-4">
      ...
      {showForm && <CategoriesForm_1.CategoriesForm id={editingId} onClose={handleFormClose}/>}
