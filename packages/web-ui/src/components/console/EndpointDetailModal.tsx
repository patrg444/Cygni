      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center gap-4">
            <span
              className={`px-3 py-1 text-sm font-semibold rounded-md ${getMethodColor(endpoint.method)}`}
            >
              {endpoint.method}
            </span>
        ...
        <div className="border-b">
          <nav className="flex px-6">
            {(["details", "request", "response", "test"] as const).map(
              (tab) => (
                <button
                  key={tab}
              ...
              {endpoint.middleware && endpoint.middleware.length > 0 && (
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {endpoint.middleware.map((mw, index) => (
                      <span
                        key={index}
