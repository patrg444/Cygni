  ...
  return (
    <>
      <div className="space-y-6">
        ...
        {/* Endpoints List */}
        {Object.entries(groupedEndpoints).map(([file, fileEndpoints]) => (
          <div key={file} className="bg-white rounded-lg shadow-sm border">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <span
                        className={`px-3 py-1 text-xs font-semibold rounded-md border ${getMethodColor(
                          endpoint.method,
                        )}`}
                      >
                        {endpoint.method}
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-500">
                      {endpoint.middleware &&
                        endpoint.middleware.length > 0 && (
                          <span>{endpoint.middleware.length} middleware</span>
                        )}
        ...
        {filteredEndpoints.length === 0 && (
          <div className="bg-white rounded-lg shadow-sm border p-12">
            <div className="text-center">
              <CodeIcon className="w-12 h-12 text-gray-300 mx-auto mb-4" />
